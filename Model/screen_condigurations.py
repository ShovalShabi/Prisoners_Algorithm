...
# <<<<<<< HEAD
# bg_img = pygame.transform.scale(pygame.image.load(os.path.join("../View/Resources", "Lunatic_Room.jpg")).convert_alpha(), (600, 900))
# =======
# bg_img = pygame.transform.scale(pygame.image.load(os.path.join("../View/Resources", "Lunetic_Room.jpg")).convert_alpha(), (600, 900))
# >>>>>>> 6c30814524e66aa7578ffa8b5cf562bbba775d33
